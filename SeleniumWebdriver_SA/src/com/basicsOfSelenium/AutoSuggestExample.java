...
public class AutoSuggestExample {
	...
	public void testcase1() throws Throwable {
		...
		driver.findElement(By.xpath(".//*[@id='uh-search-box']")).sendKeys("bang");
		//select 'bangkok'
		
		 List<WebElement> li = driver.findElements(By.xpath("html/body/div[2]/div/div/div/div/div/div/div[2]/div/div/form/table/tbody/tr/td[1]/div[1]/div/ul/li"));
	        for( int i=0;i<li.size();i++){
	            if(li.get(i).getText().equals("bangkok")){
	                li.get(i).click();
	                break;
	            }
	        }
